...
uint16_t TBD_WiFi_Portail_FileSystem::listDir(const String &indent, const String &path, _Directory* newDir)
{
    uint16_t dirCount = 0;
...
String TBD_WiFi_Portail_FileSystem::getFilesListJson() const{
