...
TBD_WiFi_Portail_FilesManager::TBD_WiFi_Portail_FilesManager(TBD_WiFi_Portail_SerialDebug &serialDebug, TBD_WiFi_Portail_FileSystem &fileSystem) : _serialDebug(&serialDebug),
...
void TBD_WiFi_Portail_FilesManager::add(TBD_WiFi_Portail_OTA &ota)
{
    this->_ota = &ota;
}
...
// -------------------------------------------- Load config project ------------------------------------------------
void TBD_WiFi_Portail_FilesManager::loadConfigProject(const String &filename, TBD_WiFi_Portail_Package *package)
{
...
// ---------------------------------------------- Load config Wifi -------------------------------------------------
void TBD_WiFi_Portail_FilesManager::loadConfigAllWifi(const String &filename, WifiAll *wifiAll)
{
    DynamicJsonDocument doc(JSON_OBJECT_SIZE(6) + JSON_OBJECT_SIZE(6) + JSON_ARRAY_SIZE(1) + 10 * (JSON_OBJECT_SIZE(8) + 25));
...
// ---------------------------------------------- Load config FTP --------------------------------------------------
void TBD_WiFi_Portail_FilesManager::loadConfigFTP(const String &filename, TBD_WiFi_Portail_FTP *ftpSrvLogin)
{
#ifdef USE_FTP
...
// ---------------------------------------------- Load config OTA --------------------------------------------------
void TBD_WiFi_Portail_FilesManager::loadConfigOTA(const String &filename, TBD_WiFi_Portail_OTA *ota)
{
#ifdef USE_OTA
    if (ota != nullptr)
    {
...
void TBD_WiFi_Portail_FilesManager::readFile(const String &filename)
{
...
// --------------------------------- Function to remove file from fileSystem -----------------------------------
void TBD_WiFi_Portail_FilesManager::deleteFile(const String &path)
{
...
bool TBD_WiFi_Portail_FilesManager::saveJSonToAFile(DynamicJsonDocument *doc, const String &filename)
{
...
JsonObject TBD_WiFi_Portail_FilesManager::getJSonFromFile(DynamicJsonDocument *doc, const String &filename)
{
