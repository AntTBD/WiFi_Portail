...
//TBD_WiFi_Portail_SerialDebug::TBD_WiFi_Portail_SerialDebug(HardwareSerial& port): _stream(&port) {}
TBD_WiFi_Portail_SerialDebug::TBD_WiFi_Portail_SerialDebug(HardwareSerial &port, long baudRate, bool wifiDiagnostic) : _stream(&port),
                                                                                                                       _baudRate(baudRate),
...
void TBD_WiFi_Portail_SerialDebug::setDebug(bool debug)
{
    this->_debug = debug;
    this->println((String)F("Set Serial Debug to : ") + this->_debug);
}
bool TBD_WiFi_Portail_SerialDebug::getDebug() const
{
    return this->_debug;
}
