...
TBD_WiFi_Portail_Wifi::TBD_WiFi_Portail_Wifi(TBD_WiFi_Portail_SerialDebug &serialDebug /*, TBD_WiFi_Portail_FilesManager& filesManager*/, WiFiMode_t startMode, bool resetWifi) : _serialDebug(&serialDebug) /*,
...
String TBD_WiFi_Portail_Wifi::wifiStatusToString() const
{
    String status = F("");
    switch (WiFi.status())
    {
...
DynamicJsonDocument TBD_WiFi_Portail_Wifi::getNetworkInfosJson()
{
...
String TBD_WiFi_Portail_Wifi::getNetworkInfosString()
{
    String jsonStringWifiInfos;
    jsonStringWifiInfos.reserve(2000);
    serializeJsonPretty(this->getNetworkInfosJson(), jsonStringWifiInfos); // on remplie la string avec les infos de JSONInfo sous forme sérialisé
