...
public:
    ...
    WifiAll(const String &hostname, const String &mdnsName, std::vector<STA> &allSTA, WiFiMode_t mode, bool resetWifi);
    ...
    WifiAll(const String &hostname, const String &mdnsName, const AP ap, std::vector<STA> &allSTA, WiFiMode_t mode, bool resetWifi);
