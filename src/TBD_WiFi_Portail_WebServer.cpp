...
TBD_WiFi_Portail_WebServer::TBD_WiFi_Portail_WebServer(TBD_WiFi_Portail_SerialDebug &serialDebug, TBD_WiFi_Portail_FileSystem &fileSystem, TBD_WiFi_Portail_Wifi &wifi, int port) : _serialDebug(&serialDebug),
...
void TBD_WiFi_Portail_WebServer::begin()
{
    ...
    this->server->onNotFound(
        ...
        [&](AsyncWebServerRequest *request)
        { this->handleWebRequests(request); }); // if someone requests any other file or page, go to function 'handleWebRequests'
...
void TBD_WiFi_Portail_WebServer::replyOKWithMsg(const String &msg, AsyncWebServerRequest *request)
{
...
void TBD_WiFi_Portail_WebServer::replyNotFound(String msg, AsyncWebServerRequest *request)
{
    ...
    String messageHTML = F("<html><head><title>ESP8266 Web Server - Error 404</title><meta charset='UTF-8'><link rel='shortcut icon' href='#'></head><body style='background:#222;color:white;'><div style='text-align:center'><h1>Error 404:</h1><br><h3>Sorry, that page cannot be found!</h3><br></div><p>");
    messageHTML += msg;
...
void TBD_WiFi_Portail_WebServer::replyBadRequest(const String &msg, AsyncWebServerRequest *request)
{
...
void TBD_WiFi_Portail_WebServer::replyServerError(const String &msg, AsyncWebServerRequest *request)
{
    this->_serialDebug->println(msg);
...
void TBD_WiFi_Portail_WebServer::handleDebug(AsyncWebServerRequest *request)
{
